...
$(".next").click(function()  { 
  ...
  $("body").css("background-color","#474747");
  $(".box").css("background-color","transparent"); 
  $('.text1').prepend(things[Math.floor(Math.random()*things.length)]);
  $('.text2').prepend(places[Math.floor(Math.random()*places.length)]);
  $('.text3').prepend(places[Math.floor(Math.random()*places.length)]);
  $('.text4').prepend(places[Math.floor(Math.random()*places.length)]);
  isActive = true;
});
...
$(".button2").click(function()  { 
  ...
  $('.text3').append(places[Math.floor(Math.random()*places.length)]);
  $('.text4').append(places[Math.floor(Math.random()*places.length)]);
  isActive = true;
});
